...
<div class="album pt-4 bg-light">
    <div class="container">
        <h2 class="text-center pb-2">Najnowsze artykuły (Ilość
            wszystkich: <?= $modelArticle->getCountOfAllArticles(); ?>)</h2>
        <div class="row text-center">
            <?php foreach ($modelArticle->getArticles(3) as $article): ?>
                <div class="col-md-4">
        ...
        <div class="container">
            <h2 class="text-center pb-2">Losowi autorzy (Ilość wszystkich: <?= $modelAuthor->getCountOfAllAuthors(); ?>
                )</h2>
            <div class="row text-center">
                <?php foreach ($modelAuthor->getRandomAuthors(3) as $author): ?>
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img class="card-img-top image-custom-style-list"
